...
Initialized Aegis Earth as a Sprint 1 MVP codebase with separate frontend, backend, service boundary, environment, and documentation structure.

### Engineering Notes

- Frontend uses React, Vite, TypeScript, Tailwind CSS, shadcn-style local UI primitives, Framer Motion, Lucide icons, and Leaflet.
